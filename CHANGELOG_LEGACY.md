...
Sharetribe Web Template was built on top of FTW-product, which was build on top of FTW-daily. This
changelog contains changes that are inherited from those templates.
